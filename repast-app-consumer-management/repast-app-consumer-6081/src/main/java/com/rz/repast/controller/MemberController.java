...
public class MemberController extends BaseController {
    ...
    public ResultData loginOut(@RequestParam("token") String token){
        ...
        return super.operationFailed(LoginStatus.LOGOUT_WRONG.getMsg());
    }
