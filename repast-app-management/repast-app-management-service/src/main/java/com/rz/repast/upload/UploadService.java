 ...
 * 通过ftp进行上传和下载
 **/
package com.rz.repast.upload;

import com.rz.repast.properties.FtpProperties;
import com.rz.repast.utils.DateUtil;
import com.rz.repast.utils.FileNameUtil;
import com.rz.repast.utils.FtpUtil;
...
public class UploadService {
    ...
    public Boolean upload(MultipartFile file,String token){
        ...
        // 2.filePath
        String filePath = DateUtil.formatDate(new Date(), StaticCode.FORMAT_DATE);
        try {
